...
- With event-level completed/terminated/withdrawn probabilities averaging **16.4% terminated/withdrawn** (terminated loss 25%, withdrawn loss 35%): mean **1.94%**, 5th-pct **-2.62%** — the tail is deal-outcome risk, not election risk.
